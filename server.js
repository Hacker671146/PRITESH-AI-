...
function generateMockData() {
    ...
    const basePeriod = 100000 + Math.floor(Math.random() * 1000);
    ...
    try {
        ...
        if (currentPeriod !== lastPeriod) {
            ...
            if (activeResult && predictedPeriod) {
                ...
                console.log(`[${new Date().toISOString()}] 📊 Period ${predictedPeriod}`);
                ...
                console.log(`   📈 Stats: Total=${stats.totalPredictions}, Wins=${stats.totalWins}, Losses=${stats.totalLosses}, Acc=${stats.accuracy.toFixed(1)}%`);
