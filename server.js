...
// =====================================================================
// HYBRID ADVANCED LOGICS ENGINE (ported from Python)
// =====================================================================
...
let lastPeriod = null;
let activeResult = null;        // { period, prediction, digit, confidence }
...
async function processLoop() {
    ...
    if (currentPeriod !== lastPeriod) {
        ...
        // Make new prediction for next period using last three numbers
...
// Root now returns everything: current prediction, stats, and full history
app.get('/', (req, res) => {
    ...
    res.json({
        currentPrediction,
        stats,
        history: history,        // full period-wise tracking
        historyCount: history.length
    });
});

// Full history (same as above but only history)
...
app.listen(PORT, () => {
    ...
    console.log(`👉 Full tracking available at http://localhost:${PORT}/`);
});
