...
async function fetchData() {
    try {
        ...
        console.log('⚠️ Using fallback data (live API error):', error.message);
...
function generateFallbackData() {
    ...
    try {
        ...
        console.log('⚠️ No local data file found, generating mock data');
    }
...
async function processLoop() {
    try {
        ...
        dataSource = fs.existsSync('./data.json') ? 'local' : 'mock';
...
console.log('📡 Data source will be: API → Local File → Mock Data\n');
...
app.listen(PORT, () => {
    ...
    console.log('\n📌 Available Endpoints:');
    console.log('  GET /        - Full data with predictions & history');
    console.log('  GET /history - Complete period-wise history');
    console.log('  GET /stats   - Statistics only');
    console.log('  GET /ping    - Health check');
    console.log('  POST /reset  - Reset all history\n');
});
