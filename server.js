    ...
    try {
        ...
        if (currentPeriod !== lastPeriod) {
            ...
            if (lastThreeNumbers.length === 3) {
                ...
                console.log(`\n🔮 NEW PREDICTION for ${nextPeriod}: ${result.prediction} (${result.digit}) @ ${result.confidence}%`);
...
app.listen(PORT, () => {
    ...
    console.log(`\n📌 Endpoints:`);
    console.log(`  GET /        - Full data + next prediction`);
