...
function checkPreviousPrediction(period, actualNumber) {
    ...
    console.log(`\n${'='.repeat(60)}`);
    console.log(`📊 RESULT FOR PERIOD ${period}`);
    console.log(`${'='.repeat(60)}`);
    console.log(`🎯 Predicted: ${predictedCategory}`);
    console.log(`✅ Actual: ${actualCategory} (Number: ${actualNumber})`);
    console.log(`🏆 Result: ${isWin ? "WIN ✅" : "LOSS ❌"}`);
    console.log(`📈 Confidence: ${predObj.confidence}`);
...
app.get('/trade', (req, res) => {
    ...
    const response = {
        ...
        // Current Prediction - FULLY SHOWING
        prediction: {
        ...
        performance: {
            ...
            currentStreak: resultsHistory.length > 0 ? 
                ...
                "N/A",
            winLossRatio: losses > 0 ? (wins/losses).toFixed(2) : "∞"
        },
        
        // Recent Results (Last 10) - FULL HISTORY
...
app.get('/', (req, res) => {
    ...
    res.json({ 
        status: "active",
        name: NAME, 
        version: "3.2 - Complete Prediction System",
        stats: {
            totalTrades: totalTrades,
            wins: wins,
            losses: losses,
        ...
        currentPrediction: currentPrediction ? {
            ...
            confidenceValue: currentPrediction.confidenceValue.toFixed(2) + "%"
...
app.get('/health', (req, res) => {
    ...
    res.status(200).json({
        ...
        lastResult: lastResult ? lastResult.result : "None"
    });
});
